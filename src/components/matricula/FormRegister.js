...
import validateForm, {initialValues, initialValuesEdit} from '@/components/matricula/validation';
        ...
        <div className='py-4'>
            <form onSubmit={formik.handleSubmit}>
                ...
                <div className='formgrid grid'>
                    ...
                    <div className='field col'>
                        <div className='flex-auto mb-4'>
                            <label htmlFor='tutorName' className='font-bold block mb-2'>Nombre completo
                                apoderado</label>
                            <div className='p-inputgroup w-full'>
                                <InputText
                                    id='tutorName'
                        ...
                        <div className='flex-auto mb-4'>
                            <label htmlFor='learnIssue' className='font-bold block mb-2'>Problemas de
                                aprendizaje</label>
                            <div className='p-inputgroup w-full'>
                                <Dropdown
                                    inputId='learnIssue'
